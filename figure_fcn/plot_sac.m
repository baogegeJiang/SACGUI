...
hold on
if ~isnan(sac.F)
p=sac.F;Y=get(gca,'Ylim');plot([p(1),p(1)],[Y(1)*0.8,Y(2)*0.8],'r');text(p(1),Y(2)*0.9,'F');end
if ~isnan(sac.A)
p=sac.A;Y=get(gca,'Ylim');plot([p(1),p(1)],[Y(1)*0.8,Y(2)*0.8],'r');text(p(1),Y(2)*0.9,'P');end
if ~isnan(sac.T0)
p=sac.T0;Y=get(gca,'Ylim');plot([p(1),p(1)],[Y(1)*0.8,Y(2)*0.8],'r');text(p(1),Y(2)*0.9,'S');end
hold off
